...
cd ./dist
tar -czvf ./pdf-annots2json.darwin.amd64.tar.gz ./pdf-annots2json
rm ./pdf-annots2json
cd ..
...
cd ./dist
tar -czvf ./pdf-annots2json.darwin.arm64.tar.gz ./pdf-annots2json
rm ./pdf-annots2json
cd ..
...
cd ./dist
tar -czvf ./pdf-annots2json.linux.amd64.tar.gz ./pdf-annots2json
rm ./pdf-annots2json
cd ..
...
cd ./dist
zip ./pdf-annots2json.windows.amd64.zip ./pdf-annots2json.exe
