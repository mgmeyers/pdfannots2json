...
CGO_ENABLED=1 GOOS=darwin GOARCH=amd64 go build -trimpath -o ./dist/pdf-annots2json.darwin.amd64 .
cd ./dist
...
CGO_ENABLED=1 GOOS=darwin GOARCH=arm64 go build -trimpath -o ./dist/pdf-annots2json.darwin.arm64 .
cd ./dist
...
CGO_ENABLED=1 GOOS=linux GOARCH=amd64 CC="x86_64-unknown-linux-gnu-gcc" go build -trimpath -o ./dist/pdf-annots2json.linux.amd64 .
cd ./dist
...
CGO_ENABLED=1 GOOS=windows GOARCH=amd64 CC="x86_64-w64-mingw32-gcc" go build -trimpath -o ./dist/pdf-annots2json.windows.amd64.exe .
cd ./dist
